...
const Mainpage: React.FC = () => {
  return (
    <div className="bg-[#dcf1f7]">
      ...
      <MainContent
        brandName={"پرسیس"}
        deviceImg={maindevice}
        description={"شرکت هوش مصنوعی"}
      ></MainContent>
      <Features>
        <FeatureBox
          title={"دانش گسترده"}
          description={
            "دسترسی به اطلاعات متنوع و پاسخگویی به سوالات در زمینه‌های گوناگون"
          }
        ></FeatureBox>
        <FeatureBox
          title={"جستجوی هوشمند"}
          description={
            "جستجوی سریع و دقیق اطلاعات در اینترنت و فایل‌های دستگاه شما"
          }
        ></FeatureBox>
        <FeatureBox
          title={"هماهنگ با خانه هوشمند"}
          description={
            "کنترل و مدیریت دستگاه‌های هوشمند خانگی از طریق دستورات صوتی"
          }
        ></FeatureBox>
        <FeatureBox
          title={"مکالمه روان فارسی"}
          description={"تعامل طبیعی با درک و پاسخ‌دهی روان به زبان فارسی"}
        ></FeatureBox>
      </Features>
      <Examples>
